...
> Do not edit manually â entries are added by the app from your iPhone.
...
| `beers` | `DATE \| beers \| PINTS` | `2026-04-19 \| beers \| 3` _(legacy â use drinks)_ |
...
- `run` / `stair` â adds to deficit (positive)
- `drinks` / `beers` â reduces deficit (negative)
- `cheat` â reduces deficit if `~NNN kcal extra` is included in the description

## Log

2026-04-13 | weight | 85.8 | Morning after spa evening, two rounds of sauna + ice baths
2026-04-13 | run | 2 min |  km | 14 kcal
