...
> Do not edit manually Ã¢ÂÂ entries are added by the app from your iPhone.
...
| `beers` | `DATE \| beers \| PINTS` | `2026-04-19 \| beers \| 3` _(legacy Ã¢ÂÂ use drinks)_ |
...
- `run` / `stair` Ã¢ÂÂ adds to deficit (positive)
- `drinks` / `beers` Ã¢ÂÂ reduces deficit (negative)
- `cheat` Ã¢ÂÂ reduces deficit if `~NNN kcal extra` is included in the description
...
2026-04-14 | cheat | DOner kebab and chips, ~2500 kcal | replaces: Double Shake (170 kcal)
