...
> Do not edit manually ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ entries are added by the app from your iPhone.
...
| `beers` | `DATE \| beers \| PINTS` | `2026-04-19 \| beers \| 3` _(legacy ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ use drinks)_ |
...
- `run` / `stair` ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ adds to deficit (positive)
- `drinks` / `beers` ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ reduces deficit (negative)
- `cheat` ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ reduces deficit if `~NNN kcal extra` is included in the description
...
2026-04-14 | cheat | Pizza, ~1500 kcal
