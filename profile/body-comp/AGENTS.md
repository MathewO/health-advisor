...
- **`profile/body-comp/rounds/<DATE>_<label>/`** — each round is one folder with:
...
See **`profile/body-comp/README.md`** for security rules and the **rounds index table**.
...
3. Compare rounds using **matching poses** — arms-raised shots are not directly comparable to relaxed sides.
